...
const projects: Project[] = [
  ...
  },
  {
    id: 21,
    title: "Car Game",
    description: "3D Collectible Car Game",
    fullDescription:
      "Simple 3D car game with 25 levels, coin collection, and world navigation. Features arrows showing direction to nearest coins.",
    category: "game",
    tech: ["Unity 3D", "C#"],
    team: "Solo Developer",
    year: "B.E. Project",
  },
  {
    ...
    description: "Web Application for Tractor Order Management",
    fullDescription:
      "Web application for managing tractor sales and order records online, allowing dealers and customers to place orders via the web interface.",
    category: "freelance",
    tech: ["Web", "Database"],
    team: "Solo Developer",
